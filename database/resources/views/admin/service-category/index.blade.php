...
@section('content')
    @include('admin.service-category.form-modal')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Data Kategori Blog</h4>
...
@push('script')
    ...
    <script type="text/javascript" src="{{ asset('js/service-categories-admin.js') }}"></script>
@endpush
